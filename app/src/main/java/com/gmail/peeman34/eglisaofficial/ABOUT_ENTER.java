...
public class ABOUT_ENTER extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        AboutImage = (ImageButton)findViewById(R.id.aboutenterimage);
        AboutTitle = (EditText)findViewById(R.id.aboutentertitle);
        AboutDescription = (EditText)findViewById(R.id.aboutenterdescribe);


        AboutPost = (Button)findViewById(R.id.aboutenterypost);
        ...
        AboutPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startPosting();
            }
    ...
    private  void startPosting(){
        final String titleval = AboutTitle.getText().toString();
        final  String descval =AboutDescription.getText().toString();


        if (!TextUtils.isEmpty(titleval) && !TextUtils.isEmpty(descval)  && mImageUri !=null){
            mProgress.setMessage("Posting ABOUT YOUR CHURCH");

            mProgress.show();
            StorageReference filepath = mStorage.child("AboutPhotos").child(mImageUri.getLastPathSegment());
                                        ...
                                        mCHURCHCHOSEN.addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                newPost.child("churchname").setValue(dataSnapshot.child("title").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()){
                                                            startActivity(new Intent(ABOUT_ENTER.this, ABOUTVIEW.class));
                                                        }
                                                    }
                                                });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                AboutImage.setImageURI(mImageUri);
